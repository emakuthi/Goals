...
export class GoalComponent implements OnInit {
  goals = [
    ...
    new Goal(3, 'Get new Phone Case','Diana has her birthday coming up soon', new Date (2018,3,14)),
    new Goal(4, 'Get Dog Food','Pupper likes expensive sancks', new Date (2018,3,14)),
